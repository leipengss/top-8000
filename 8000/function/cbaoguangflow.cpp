...
bool CBaoguangFlow::ccd_rw()
{
    ...
    if((true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD3Y))
            ...
            &&(true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD1Y))
            && (true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD2Y))
            &&(true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD3X))
            && (true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD4X))
            &&(true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD1X))
            && (true==update_thread->threaddriver->Axis_OrgLimit(AXIS_CCD2X)))
    {
